...
* add vm.compile(startPc)
** loop until no more changes
** Replace unused COPY with NOP
** Replace NOP GOTO with GOTO
** Replace GOTO NOP with GOTO
*** extend
** replaces NOP NOP with GOTO
** replace GOTO->GOTO with GOTO
*** extend
